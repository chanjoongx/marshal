...
call, so it routes to B15 and shows a 'learned: avoids rack B3' chip. Approve, and on the forecast
...
routes to B15 on its own. Encoding every such combination as if-statements explodes and cannot
